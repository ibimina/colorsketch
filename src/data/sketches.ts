...
/**
 * Filter sketches by category
 */
export function getSketchesByCategory(category: Category | "all"): Sketch[] {
    if (category === "all") return sketches;
 ...
 */
export function getFeaturedSketches(): Sketch[] {
    return sketches.filter(sketch => sketch.isFeatured);
}

/**
 * Get new sketches
 */
export function getNewSketches(): Sketch[] {
    return sketches.filter(sketch => sketch.isNew);
}

/**
 * Get editor's choice sketches
 */
export function getEditorChoiceSketches(): Sketch[] {
    return sketches.filter(sketch => sketch.isEditorChoice);
}
